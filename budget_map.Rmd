...
ggplot(df.other, aes(x=subs, y=value)) +
    ...
    xlab('Locations') + ylab('Expenditure A$ ,000')
...
I will explore using ABS SLA1 as a proxy for suburbs and this may solve many problems including the simple deliniation of metro and regional locations.
...
pal <- colorQuantile("Blues", abs.sub@data$expenditure, n = 6, na.color = 'red')
